...
\begin{center}
  \includegraphics[scale=0.5]{imagenes/tab5vacio.png}
\end{center}
  \caption{Tablero vacío de $5 \times 5$}\label{fig:tab5vacio}
\endminipage\hfill
\minipage{0.32\textwidth}
\begin{center}
  \includegraphics[scale=0.5]{imagenes/tab5nuestro.png}
\end{center}
  \caption{Sol. no independiente}\label{fig:tab5nunestro}
\endminipage\hfill
\minipage{0.32\textwidth}%
\begin{center}
  \includegraphics[scale=0.5]{imagenes/tab5cidm.png}
\end{center}
  \caption{Solución independiente}\label{fig:tab5cidm}
\endminipage
\end{figure}

Si nuestro tablero fuera el de la Figura \ref{fig:tab5vacio}, una solución posible (de hecho, la encontrada con el algoritmo propuesto en el TP1) es la Figura \ref{fig:tab5nunestro}. Esta solución podemos observar que es dominante, pero no independiente puesto que el caballo de la fila 3 - columna 2 amenaza al de la fila 4 - columna 4. Sin embargo en este caso, existe una solución CIDM como se muestra en la Figura \ref{fig:tab5cidm}. 
