...
\begin{equation*}
\begin{array}{l}
T(n) = 2\mathcal{O}(n \cdot n) + 2\mathcal{O}(n) + \mathcal{O}(n-1) + \mathcal{O}(n \cdot log(n))\\
T(n) = 2\mathcal{O}(n^2)\\
T(n) = \mathcal{O}(n^2)
\end{array}
\end{equation*}
