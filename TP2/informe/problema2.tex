...
Las Figuras \ref{fig:ejzombie0}, \ref{fig:ejzombie1}, \ref{fig:ejzombie2}, \ref{fig:ejzombie3} y \ref{fig:ejzombie4} muestran la forma de operar del algoritmo descrito.
