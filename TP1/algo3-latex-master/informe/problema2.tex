...
Decidimos representar cada frecuencia con una estructura que contenga sus valores $costo$ (por minuto), $inicio$ y $fin$, además de un valor $nombre$ que identificará a la frecuencia según el orden en el que vino dada.  A su vez, decidimos contar con una estructura que representará una transmisión.
...
\begin{figure}[!ht]
\begin{codebox}
\Procname{$\proc{mezclar_freq}(Lista$_$transmision$ $trans1, Lista$_$transmision$ $trans2)$}
...
\begin{figure}[!ht]
\begin{codebox}
\Procname{$\proc{aux_mezcla_a}(it$_$Lista$_$transmision$ $itA, it$_$Lista$_$transmision$ $itB, Lista$_$transmision$ $res)$}
...
\begin{codebox}
\Procname{$\proc{aux_mezcla_b}(it$_$Lista$_$transmision$ $itA, it$_$Lista$_$transmision$ $itB, Lista$_$transmision$ $res)$}
\li res $\leftarrow$ agregar atrás el dato de itA
