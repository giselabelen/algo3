...
donde $C$ es la cantidad de ciudades que se podrían recuperar siguiendo la solución y, suponiendo que el país tiene $n$ ciudades, $s_{1}$, ..., $s_{n}$ son las cantidades de soldados de refuerzo que deberían enviarse a cada una de las ciudades de la instancia. Es decir, a la ciudad $i$ se enviaran $s_{i}$ soldados de refuerzo (las ciudades se numeran de 1 a n segun el orden dado por la entrada)
